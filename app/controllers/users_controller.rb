...
# antes de ejecutar las acciones se ejecuta  before_action el cual llama la funcion :set_user y se ejecuta solo en la funciones show edit update y destroy
# refactoriza el codigo q
